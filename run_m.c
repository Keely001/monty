...
/**
 * token_len - gets the global var length
 * Return: the length
 */
...
/**
 * _empty_line - checks the line from getline if it only has delimers.
 * @line: the line
 * @delims:delimiter
 * Return:1 or 0
 */
...
/**
 * _op_func - gets the appropriate function
 * @opcode: opcode
...
/**
 * run_m - execute monty file
 * @script_fd: file descriptor for the monty file
